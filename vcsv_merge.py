...
parser = argparse.ArgumentParser(description="""Read in a VCSV file (from Cadence ViVA waveform data) into a python dataframe with detected column names and write it out as a csv file""")
